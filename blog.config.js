...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '14e38a76125880b6a65bc47d14be68ba',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '专业三维建模和渲染技术服务', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jimuhaoke.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '积木好课,jimuhaoke,三维建模,AutoCAD，solidworks,3dsmax,三维渲染,建模渲染教程', // 网站关键词 英文逗号隔开
