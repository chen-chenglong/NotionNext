...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '陈成龙,陈成龙的博客,chenchenglong,chenchenglong.com', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2021035365号-2', // 备案号 闽ICP备XXXXXXX
